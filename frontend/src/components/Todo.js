...
function Todo() {
    ...
    useEffect(() => {
        axios.get('http://13.201.73.110:3000/getTodoList')
            .then(result => {
    ...
    const addTask = (e) => {
        ...
        axios.post('http://13.201.73.110:3000/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline })
            .then(res => {
                console.log(res);
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post('http://13.201.73.110:3000/updateTodoList/' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete('http://13.201.73.110:3000/deleteTodoList/' + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
